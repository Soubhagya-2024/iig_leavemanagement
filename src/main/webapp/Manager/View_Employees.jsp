...
.dropdown:hover .dropdown-content {
 ...
 <script>
    function carryForwardLeaves(event) {
        event.preventDefault(); 

        var confirmation = confirm("Are you sure you want to carry forward leave details?");
        if (confirmation) {
    ...
    function carryForwardemployee(event) {
        event.preventDefault(); 

        var confirmation = confirm("Are you sure you want to carry forward Employee leave details?");
        if (confirmation) {
            window.location.href = "carryForwardProcess.jsp";
        } else {
           
           
            alert("Employee details carry forward canceled.");
...
<body>
    ...
    <button>
        ...
        Export excel
         ...
         <a href="Pdf_View_Employees.jsp" class="download-btn">
...
<div class="button-container">
    ...
    <form action="carryForwardProcess.jsp" method="post">
        <input type="submit" value="Carry Forward Leave" name="carryForwardBtn" onclick="carryForwardemployee(event)">
    </form>

<!--  
    <form action="carryForwardProcessleave.jsp" method="post">
        <input type="submit" value="2.Carry Forward Leave" name="carryForwardBtn" onclick="carryForwardLeaves(event)">
    </form>-->
    <form action="ViewcarryForwardProcess.jsp" method="post">
        <input type="submit" value="View Details" name="carryForwardBtn" >
    </form>
    ...
    <form action="" method="post">
        <input type="text" placeholder="Search employee..." name="searchInput">
            ...
            <thead>
             ...
             <%
                try{
                    ...
                    String sql="SELECT empid, fullname, email, Mobile, Location, Qualification, dob, doj FROM Employees";
                    ...
                    <tr>
                        ...
                        <td><%=resultSet.getString("email") %></td>
                         <td><%=resultSet.getString("Mobile") %></td>
                            ...
                            <td> <form action="Employee_Profile_Edit.jsp" method="post">
                              <input type="hidden" name="empid" value="<%=resultSet.getString("empid")%>">
         <button type="submit" name="action" value="Edit" style="background-color: #4CAF50; color: white; padding: 8px 16px; border: none; cursor: pointer; border-radius: 4px;">Edit</button>
         </form> </td>
        <td>
    <form action="Employee_Profile_Delete.jsp" method="post" onsubmit="return confirmDelete();">
        <input type="hidden" name="empid" value="<%=resultSet.getString("empid")%>">
        <input type="hidden" name="fullname" value="<%=resultSet.getString("fullname")%>">
        <button type="submit" name="action" value="Delete" style="background-color: #f44336; color: white; padding: 8px 16px; border: none; cursor: pointer; border-radius: 4px;">Delete</button>
    </form>
</td>
...
<script>
    function confirmDelete() {
        ...
        <td>
    <!-- Pass empid to retrieve details -->
    <form action="Employee_Profile_View.jsp" method="post">
        <input type="hidden" name="empid" value="<%=resultSet.getString("empid")%>">
          <input type="hidden" name="fullname" value="<%=resultSet.getString("fullname")%>">
        <button type="submit" name="action" value="details" style="background-color: blue; color: white; padding: 8px 16px; border: none; cursor: pointer; border-radius: 4px;">Details</button>
    </form>
</td>
