...
try {
    ...
    String query = "SELECT * FROM leave_requests  WHERE status = 'Rejected';";
...
<head>
 ...
 <style>
        ...
        /* Set the A4 page size */
        @page {
            size: A4;
            margin: 20mm;
        }

        /* Adjustments for table to fit A4 page */
        table {
            width: 100%;
...
<body>
    ...
    response.setHeader("Content-Disposition", "attachment; filename=Reject_Request_Details.xls");
%>
    </tbody>
</table>
</body>
