...
/* Additional table styles (as needed) */
.table table {
    width: 100%;
    /* Other table styles */
    /* ... */
...
<body>
    ...
    <div class="container">
      ...
      <%   String empid = request.getParameter("empid"); %>  
          ...
          <a href="Report_Employee_Profile_View.jsp?empid=<%= empid %>" class="download-btn">
    <button>
     ...
     <a href="Pdf_Employee_Profile_View.jsp?empid=<%= empid %>" class="download-btn">
