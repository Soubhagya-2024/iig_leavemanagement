...
try {
    ...
    try {
        ...
        Paragraph leaveHistoryHeading = new Paragraph("Rejected Leave :", FontFactory.getFont(FontFactory.HELVETICA, 14, Font.BOLD));
        ...
        for (String header : headers) {
           ...
           // headerCell.setBackgroundColor(new BaseColor(0, 28, 78));
        ...
        response.setHeader("Content-Disposition", "attachment; filename=Rejected_Leave_report.pdf");
