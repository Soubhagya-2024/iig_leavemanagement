    ...
    <div class="container">
        ...
        <!-- Main Content -->
          ...
          <div class="main-content">
               <a href="Report_Reject_List.jsp" class="download-btn">
    <button>
        ...
        <a href="Pdf_Reject_Leave.jsp" class="download-btn">
            ...
            <thead>
             ...
             <%
                try{
                    ...
                    String sql="SELECT * FROM leave_requests  WHERE status = 'Rejected';";
