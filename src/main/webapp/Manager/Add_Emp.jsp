...
.dropdown:hover .dropdown-content {
    ...
    .large-container form button[type="submit"] {
        ...
        margin-top: 10px; /* Add margin between form fields and button */
    }
...
<body>
   ...
   <form action="Employee_Registration.jsp">
        <div>
        ...
        <div>
            ...
            <input type="password" id="password" name="password" placeholder="Enter valid password *"required>
        </div>
        <div>
            <label for="confirmPassword">Confirm Password:</label>
            <input type="password" id="confirmPassword" name="confirmPassword" placeholder="Enter valid password *" required>
        </div>
        <div>
