...
<body class="body">
    <body>
        ...
        <!-- Image in the body -->
        <img src="password.jpg" alt="Description of the image" width="400">
        
            <form action="forgot.jsp" method="post">
                <div class="form-group">
                    <label for="username"><h3>Enter Your Employee ID:</h3></label>
    ...
    <%
        if (request.getMethod().equals("POST")) {
            ...
            try {
                ...
                String sql = "SELECT email FROM Employees WHERE empid = ?";
